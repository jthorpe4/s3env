...
def do_burn_in(bme280, sgp):
    ...
    data = {"burn_in_time": burn_in_time, "status": "STARTED"}
    print(json.dumps(data))
...
data = {"client_mac_addr": client_mac_addr, "status": "OK"}
print(json.dumps(data))
...
data = {"message": "Setup sensors", "status": "STARTED"}
print(json.dumps(data))
...
data = {"message": "Setup sensors", "status": "OK"}
print(json.dumps(data))
...
while True:
    ...
    if not (
        ...
        data = [
            ...
            {"tag": client_mac_addr, "location": LOCATION},
        ]
